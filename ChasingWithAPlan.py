...
def next_move(hunter_position, hunter_heading, target_measurement, max_distance, OTHER = None):
	...
	#calculate the distance between the hunter and the target while assessing the target position, using the KF predicted heading and distance 
	#also keep it within max_distance
